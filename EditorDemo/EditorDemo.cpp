...
// EditorDemo.cpp : Defines the class behaviors for the application.
//
...
// The one and only CEditorDemoApp object

CEditorDemoApp theApp;


// CEditorDemoApp initialization
...
// CEditorDemoApp message handlers
